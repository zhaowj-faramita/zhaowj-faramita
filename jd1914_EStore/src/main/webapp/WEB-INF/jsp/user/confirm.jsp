...
<body>
    ...
    <div class="content">
		...
		<form action="user/addOrderForm" method="post" name="orderForm">
    		...
    		<p class="singleP"><b>送货清单</b><span><a href="user/shopCar">返回修改购物车</a></span></p>
    		<div class="bigDiv">
    			<div class="twoDiv">
    				<b>商家：briup自营</b>
    				<%int maxNum = 0,maxPrice = 0; %>
    				<c:forEach var="orderLines" items="${sessionScope.ShopCar}" begin="0" end="4" varStatus="n">
					<ul class="oneUL">
    					<li>
    						<img src="images/viewBook.png" class="pic">
    						<p>${orderLines.book.name}&nbsp;&nbsp;${orderLines.book.description}&nbsp;&nbsp;${orderLines.book.author}&nbsp;&nbsp;</p>
    						<p><font>¥${orderLines.book.price}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${orderLines.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    						<p><img src="images/sureLogo_14.png" alt=""><span>七天无理由退换货</span></p>

    					</li>
    					<li><pre>【赠品】  西北方向逆流风  随机  ×1</pre></li>
					</ul>
					</c:forEach>
    			</div>
    		</div>
    		...
    		<div class="money">
    			<span><font><%maxNum++;%></font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${0+sessionScope.maxPrice}</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${0+sessionScope.maxPrice}</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${0+sessionScope.maxPrice}</font><input type="image" src="images/21_03.png"></span>
    		</div>
			</form>
    	</div>
