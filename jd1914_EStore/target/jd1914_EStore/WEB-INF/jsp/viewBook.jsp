<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    com.briup.zhaowenjie.book.bean.Book,
	...
	<div class="container5">
    	<div class="cn5_top">
            ...
            <div class="cn5_top_y center01">
                ...
                <div class="cn5topy_2">
                    ...
                    <div class="pro_price">
                            <div class="pro_price_x">
                                <p> briup价：<b>￥${sessionScope.book.price}</b> <a href="#">(降价通知)</a></p>
                            </div>
                    </div>
                    <div class="pro_selects">
                    	<div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                <li>${sessionScope.book.author}</li>
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                <li>${sessionScope.book.publisher}</li>
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                                ...
                                out.write(sdf.format(book.getPubdate()));
                                %>                   
                                </li>
                                <li>包装：平装</li>
                                <li>正文语种：中文</li>
				...
				<form action="user/addShopCar" id="addCar" method="post">
                    <div class="pro_buy">
